module Parser.Parser( MoveMsg(..), isRight, parseMessage, firstMove, secondMove ) where
...
-- data TestData = TestMsg { coord :: [(String, TestData)]
--               | TestList { [TestData] } 
--               | TestValue String  
--   deriving Show
...
secondMove :: MoveMsg 
secondMove = DicMsg [
    ("coord",  CordList[CordValue "B", CordValue "4"]),
